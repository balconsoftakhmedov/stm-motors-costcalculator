...
class PassengerCustomImageCategories extends WidgetBase {
	...
	public function get_name(): string {
		return MotorsApp::STM_PREFIX . '-passenger-image-categories';
	}

	public function get_title(): string {
		return esc_html__( 'Passenger Image Categories', 'stm-motors-custom' );
	}
	...
	protected function register_controls() {
		...
		$listing_categories = stm_passenger_attributes();
	...
	protected function render() {
		...
		if ( 'yes' === $settings['show_as_carousel'] ) {
			...
			Helper::stm_ew_load_template( 'widgets/passenger-image-categories/image-categories-slider', MOTORS_ELEMENTOR_WIDGETS_PATH, $settings );
		...
		Helper::stm_ew_load_template( 'widgets/passenger-image-categories/image-categories', MOTORS_ELEMENTOR_WIDGETS_PATH, $settings );
	}
